...
**Problem it solves:** While the SNAP procedure provides assistance in dispute resolution, it does not rise to the level of due process required for a binding judgement under United Nations standards. Disputes reaching this level will be complex, will have a lot at stake, or will require legal binding resolution. UN rules thus require a small number of people to take their time examining all of the evidence, and hearing all of the arguments.
...
**From the Jurists’ perspective:** This is more labor intensive, but this is where the real money is as fees are higher and split among fewer Jurists. In order to get put on a panel, you need to have High Jurist standing. All of that work spent in SNAPs is paying off here!
